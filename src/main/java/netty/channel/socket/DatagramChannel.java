...
public interface DatagramChannel extends Channel {
	...
	ChannelFuture joinGroup(InetAddress multicastAddress, ChannelPromise promise);
	...
	ChannelFuture leaveGroup(InetAddress multicastAddress, ChannelPromise promise);
	...
	ChannelFuture block(InetAddress multicastAddress, InetAddress sourceToBlock, ChannelPromise promise);
}

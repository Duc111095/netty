...
import netty.common.util.concurrent.RejectedExecutionHandlers;
import netty.common.util.concurrent.SingleThreadEventExecutor;
...
public abstract class SingleThreadEventLoop extends SingleThreadEventExecutor implements EventLoop {
	...
	protected SingleThreadEventLoop(EventLoopGroup parent, ThreadFactory threadFactory,
		...
		this(parent, threadFactory, addTaskWakesUp, false, maxPendingTasks, rejectedExecutionHandlers);
	}

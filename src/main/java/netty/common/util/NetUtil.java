...
import netty.common.util.NetUtilInitializations.NetworkIfaceAndInetAddress;
import netty.common.util.internal.BoundedInputStream;
...
import static netty.common.util.AsciiString.indexOf;
...
public final class NetUtil {
	...
	private static final boolean IPV4_PREFERRED = SystemPropertyUtil.getBoolean("java.net.perferIPv4Stack", false);
	...
	private static String toAddressString(InetAddress ip, boolean ipv4Mapped) {
